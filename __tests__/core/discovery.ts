...
describe('Discovery core', () => {
    ...
    it('Do getPartnerInfo', async () => {
        ...
        myGateway.getPartnerInfo.mockResolvedValue({ name: 'string', nodes: [] })
    ...
    it('Do getPartners', async () => {
        ...
        myGateway.getPartners.mockResolvedValue(['string'])
    ...
    it('Do reloadCid', async () => {
        ...
        myGateway.getCid.mockResolvedValue('cid')
    ...
    it('Do reloadPartners', async () => {
        ...
        myGateway.getPartners.mockResolvedValue(['partner1', 'partner2'])
